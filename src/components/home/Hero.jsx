...
export default function Hero() {
  return (
    <section className="relative bg-[#F6F1EB] overflow-hidden">
      ...
      {/* Light background glow (reduced blur for performance) */}
      <div className="absolute -top-24 -left-24 w-[280px] h-[280px] bg-[#E9DFD3] rounded-full blur-[60px] opacity-50" />
      <div className="absolute top-1/2 -right-24 w-[320px] h-[320px] bg-[#EFE6DB] rounded-full blur-[60px] opacity-50" />

      {/* MARQUEE STRIP (Pure CSS smooth, no JS repaint loop) */}
      <div className="bg-[#1A1816] text-white text-[11px] md:text-xs py-3 overflow-hidden tracking-[0.2em]">
        <div
          className="flex whitespace-nowrap gap-20 w-max"
          style={{
        ...
        <div className="grid lg:grid-cols-2 gap-14 xl:gap-24 items-center">
          ...
          >
            ...
            <div className="flex justify-center lg:justify-start gap-2 text-[#C9A46C] mb-6">
              ...
              <span className="text-[#6A625A] text-sm ml-3">
                Loved by 4,000+ customers
              </span>
            </div>

            <h1 className="font-serif text-[42px] sm:text-[60px] lg:text-[74px] xl:text-[84px] leading-[1.05] text-[#171614] tracking-[-0.02em]">
              Transform Your Space,
              <br />
              <span className="text-[#9C8770] italic">
                Elevate Your Mood
              </span>
            </h1>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative rounded-[40px] overflow-hidden shadow-[0_15px_40px_rgba(0,0,0,0.12)]">
              <motion.img
                animate={{ y: [0, -6, 0] }}
                transition={{
                  duration: 6,
            ...
            <div className="absolute -top-6 right-8 bg-white shadow-lg px-7 py-3 rounded-full text-[#8B7D6B] font-semibold">
              Bestseller ✨
            </div>
          </motion.div>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[#F6F1EB] to-transparent"/>
    </section>
  );
}