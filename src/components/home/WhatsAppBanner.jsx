...
import { motion } from "framer-motion";
import { FaWhatsapp } from "react-icons/fa";
import { FiGift, FiBox, FiDroplet } from "react-icons/fi";
import Container from "../common/Container";
import { business } from "../../data/business";
...
export default function WhatsAppBanner() {
  ...
  return (
    <section className="relative py-20 lg:py-32 bg-[#F6F1EB] overflow-hidden">
      ...
      {/* Softer premium background glow */}
      <div className="absolute -top-16 -left-16 w-[260px] h-[260px] bg-[#E9DFD3] rounded-full blur-[70px] opacity-50" />
      <div className="absolute -bottom-16 -right-16 w-[300px] h-[300px] bg-[#EDE4D9] rounded-full blur-[70px] opacity-50" />
      ...
      <Container className="relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-14 lg:gap-24 items-center">
          ...
          >
            ...
            <h2 className="font-serif text-[34px] md:text-[50px] leading-[1.1] text-[#2C2420]">
              Create Your Own <br />
              Signature Scent
            </h2>
            ...
            <p className="mt-6 text-lg text-[#6B6257] max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Planning a wedding, gift hamper or special occasion?  
              We craft personalised scented candles designed uniquely for you.
            </p>

            {/* FEATURE LIST */}
            <div className="mt-10 grid sm:grid-cols-3 gap-6 text-sm text-[#6F6258]">

              <div className="flex items-center gap-3 justify-center lg:justify-start">
                <FiDroplet className="text-[#9C8770]" size={18} />
                Custom Fragrance
              </div>

              <div className="flex items-center gap-3 justify-center lg:justify-start">
                <FiGift className="text-[#9C8770]" size={18} />
                Premium Packaging
              </div>

              <div className="flex items-center gap-3 justify-center lg:justify-start">
                <FiBox className="text-[#9C8770]" size={18} />
                Bulk Orders
              </div>

            </div>

            {/* CTA BUTTON (CSS hover only) */}
            <div className="mt-12">
              <a href={whatsappLink} target="_blank" rel="noopener noreferrer">
                <button
                  className="group relative overflow-hidden px-12 py-5 
                  bg-[#1A1816] text-white uppercase tracking-[0.25em] text-xs
                  transition-all duration-500
                  hover:shadow-[0_15px_40px_rgba(0,0,0,0.15)]"
                >
                  <span
                    className="absolute inset-0 bg-[#3A3531]
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative overflow-hidden rounded-[40px] shadow-[0_18px_45px_rgba(0,0,0,0.12)]">

              {/* IMPORTANT: Replace with optimized local image */}
              <img
                src="https://instagram.fudr3-1.fna.fbcdn.net/v/t51.82787-15/631068619_18029437121790624_7591755427233196008_n.heic?stp=dst-jpg_e35_p640x640_sh0.08_tt6&_nc_cat=101&ig_cache_key=MzgyNzI5NTk5NDM2NzQ3NTIxNA%3D%3D.3-ccb7-5&ccb=7-5&_nc_sid=58cdad&efg=eyJ2ZW5jb2RlX3RhZyI6InhwaWRzLjE0Mzl4MTkyMC5zZHIuQzMifQ%3D%3D&_nc_ohc=6nvzj7ByxMgQ7kNvwFUyY4p&_nc_oc=Adm-6bsm-1Z_bSrmwPOVmxv7vuJ3xNdsK7p9hHyFpkcY9p5spzMhH2Lm5xMETtVzbgidgF0lpndrcsOpgLv7mxaB&_nc_ad=z-m&_nc_cid=2034&_nc_zt=23&_nc_ht=instagram.fudr3-1.fna&_nc_gid=ksO33kNu97l9Wma_L-8cDw&_nc_ss=8&oh=00_AfzS9rlyiJv2tahjzE4l3anPQ_xb8fPdufNKLU5wSu6D2g&oe=69AB2033"
                alt="Custom scented candle"
                loading="lazy"
